# Description: Training script for FLAN-T5-XXL-RN50 with overall prompt on ImageNet (standalone)
# Usage: bash train_flan_t5_xxl_RN50_imagenet_overall_prompt_standalone.sh
OMP_NUM_THREADS=2 \
